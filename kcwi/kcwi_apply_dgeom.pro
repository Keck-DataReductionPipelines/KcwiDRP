...
crota = (-(sxpar(hdr,'ROTPA',count=npa) + kdgeom.rotoff)) / !RADEG
sxaddpar,dhdr,'IFUPA',-crota*!RADEG,' IFU position angle (degrees)'
sxaddpar,dhdr,'IFUROFF',kdgeom.rotoff,' IFU-ROTPA offset (degrees)'
;
; pixel scales
