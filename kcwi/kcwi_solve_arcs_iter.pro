...
;
; CALLING SEQUENCE:
;	KCWI_SOLVE_ARCS_ITER, Specs, Kgeom, Ppar
;
; INPUTS:
...
;-
;
pro kcwi_solve_arcs_iter, specs, cntcoeff, kgeom, ppar, $
	tweak=tweak, plot_file=plot_file

pre = 'KCWI_SOLVE_ARCS_ITER'
q=''
;
...
if keyword_set(tweak) then begin
	...
	if ddisplay then $
		window,1,title='kcwi_solve_arcs_iter(2)'
	;
