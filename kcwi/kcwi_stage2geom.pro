...
;
; CALLING SEQUENCE:
;	KCWI_STAGE2GEOM, Procfname, Pparfname
;
; OPTIONAL INPUTS:
...
;
; EXAMPLE:
;	Perform stage2geom reductions on the images in 'night1/redux' directory:
;
;	KCWI_STAGE2GEOM,'night1/redux/kcwi.ppar'
;
...
;-
pro kcwi_stage2geom,procfname,ppfname,help=help,verbose=verbose, display=display
	;
	; setup
	pre = 'KCWI_STAGE2GEOM'
	startime=systime(1)
	...
	;
	; log file
	lgfil = reddir + 'kcwi_stage2geom.log'
