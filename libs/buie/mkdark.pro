...
;-
pro mkdark,root,outsuf,start,nframes,bias,dark,DDIR=ddir, $
   ...
   for ix=1,numext do begin
      ...
      for i=0,nframes-1 do begin
         ...
         if not bad[i] then begin
            ...
            if do_overscan and do_crop then begin
               ...
               if extend then $
                  print,fname[i],exptime,' overscan value is ',biasval, $
               ...
               if extend then $
                  print,fname[i],exptime,' extension ',strn(ix) $
               else $
                  print,fname[i],exptime
      ...
      if countg eq 1 then begin
         ...
         avgclip,cube,dark,noisemin=rdnoise/exptime
      endelse
      ...
      if extend then begin
         ...
         writefits,outfile,dark,hdr,/append
      endif else begin
         print,'Saving final dark frame to ',outfile
         writefits,outfile,dark,hdr
      endelse
